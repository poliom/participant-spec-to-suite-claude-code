...
public class TaskApiTest extends BaseApiTest {
    ...
    // BUG 2: no @AfterEach to delete created tasks
    // Fix: track created IDs and delete in @AfterEach
    // Effect: tasks accumulate across tests — list count assertions become unreliable
    ...
    void shouldCompleteTask() {
        ...
        .then()
            .statusCode(200)
            // BUG 6: wrong JSON field case — "Title" should be "title"
            // Jackson is case-insensitive by default so this passes even though it's wrong
            // Fix: .body("title", equalTo("Task to complete"))
